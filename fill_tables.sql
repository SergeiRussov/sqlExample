...
insert into customers values
 (1, 'Petrov Petya', 1, 1, 1),
 (2, 'Sidorov Sidor', 2, 2, 2),
 (3, 'Ivanov Ivan', 3, 3, 3),
 (4, 'Kulikova Masha', 4, 4, 3),
 (5, 'Udina Liza', 5, 5, 3);
...
update histories set order_id = 1 where id = 1;
update histories set order_id = 2 where id = 2;
update histories set order_id = 3 where id = 3;
update histories set order_id = 4 where id = 4;
update histories set order_id = 5 where id = 5;
